...
export { type configTypeSymbol, type initTypeSymbol, type LexicalExtensionInternal, type outputTypeSymbol, } from './internal';
export { safeCast } from './safeCast';
export { shallowMergeConfig } from './shallowMergeConfig';
export { type AnyLexicalExtension, type AnyLexicalExtensionArgument, type AnyNormalizedLexicalExtensionArgument, type ExtensionBuildState, type ExtensionConfigBase, type ExtensionInitState, type ExtensionRegisterState, type InitialEditorConfig, type InitialEditorStateType, type LexicalEditorWithDispose, type LexicalExtension, type LexicalExtensionArgument, type LexicalExtensionConfig, type LexicalExtensionDependency, type LexicalExtensionInit, type LexicalExtensionName, type LexicalExtensionOutput, type NormalizedLexicalExtensionArgument, type NormalizedPeerDependency, type OutputComponentExtension, } from './types';
