...
import { Search, Settings2, CreditCard, Shield, Mail, Lock, Radio, Users, Globe, Bot } from 'lucide-react';
...
import PromptsSettingsTab from './Settings/PromptsSettingsTab';
...
const sectionDefinitions: SectionDefinition[] = [
    ...
    },
    {
        ...
        keywords: ['prompt', 'ai', 'system', 'builder', 'agent', 'instructions'],
        category: 'platform',
    },
];

export default function Settings({ auth, settings, plans, aiProviders, builders, languages, notificationEvents }: SettingsPageProps) {
    ...
    const renderContent = () => {
        switch (activeSection) {
            ...
            case 'prompts':
                return <PromptsSettingsTab settings={settings.prompts} />;
            default:
                return <GeneralSettingsTab settings={settings.general} languages={languages} />;
        }
    };
