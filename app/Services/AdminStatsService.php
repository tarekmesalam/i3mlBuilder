...
class AdminStatsService
{
    ...
    /**
     * Cache duration for Firebase connection health checks (60 seconds).
     */
    protected const FIREBASE_CACHE_TTL = 60;
    ...
    {
        return Cache::remember(self::CACHE_PREFIX.'firebase', self::FIREBASE_CACHE_TTL, function () {
